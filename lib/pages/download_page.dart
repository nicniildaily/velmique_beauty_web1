...
class DownloadPage extends StatelessWidget {
  ...
  Widget _buildInstallationGuide() {
    final steps = [
      {'icon': Icons.download_rounded, 'title': 'Download the APK', 'desc': 'Click the download button above to get the APK file.'},
      {'icon': Icons.folder_open_rounded, 'title': 'Open the file', 'desc': 'Navigate to your downloads and tap the APK file.'},
      {'icon': Icons.security_rounded, 'title': 'Allow installation', 'desc': 'If prompted, allow installation from unknown sources.'},
